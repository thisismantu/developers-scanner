            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3 needs-validation" action="{{ Route('companies.store') }}" method="post"
                            novalidate>
                            @csrf
                            ...
                            <div class="col-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" checked readonly value="1" name="is_active"
                                        id="invalidCheck">
